        ...
        <div className={`${active ? "active" : ""} sidebar position-relative text-white py-4  `}>
            ...
            <div className="mt-4 p-0">
                <ul type="none" className="list-group gap-1">
                    <li className=" d-flex gap-3 align-items-center py-2 px-4 rounded-2">
                        <i className="ri-dashboard-line ri-lg py-1"></i>
                        <span className={`${active ? "d-none" : ""} flex-shrink-0`}>Dashboard</span>
                    </li>
                    <li className=" d-flex gap-3 py-2 px-4 rounded-2 align-items-center">
                        <div>
                    ...
                    {data.map((item, index) => {
                        return <li className={`d-flex gap-3 py-2 px-4 rounded-2 align-items-center ${item.name==="Content Creation"? 'selected':null}`}>
